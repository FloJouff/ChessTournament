...
<html>
   <head>
      <title>flake8 violations: .env\Lib\site-packages\mypy_extensions.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.mypy_extensions.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.mypy_extensions.source.html#l138">
                  <tt><i>138</i> <span class="k">class</span> <span class="nc">NoReturn</span><span class="p">:</span> <span class="k">pass</span></tt>
               </a>
            </li>
            </ul>
         </li>
