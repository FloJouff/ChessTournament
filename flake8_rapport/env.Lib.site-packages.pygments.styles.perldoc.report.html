...
<html>
   <head>
      <title>flake8 violations: .env\Lib\site-packages\pygments\styles\perldoc.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.pygments.styles.perldoc.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .env\Lib\site-packages\pygments\styles\perldoc.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.pygments.styles.perldoc.source.html#l27">
                  <tt><i>27</i>     </tt>
               </a>
            </li>
            </ul>
