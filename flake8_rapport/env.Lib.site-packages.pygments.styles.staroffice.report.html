...
<html>
   <head>
      <title>flake8 violations: .env\Lib\site-packages\pygments\styles\staroffice.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.pygments.styles.staroffice.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .env\Lib\site-packages\pygments\styles\staroffice.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.pygments.styles.staroffice.source.html#l25">
                  <tt><i>25</i>     <span class="n">styles</span> <span class="o">=</span> <span class="p">{</span></tt>
               </a>
            </li>
            </ul>
         </li>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.pygments.styles.staroffice.source.html#l24">
                  <tt><i>24</i>     </tt>
               </a>
            </li>
            </ul>
