...
<html>
   <head>
      <title>flake8 violations: .env\Lib\site-packages\pygments\styles\inkpot.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.pygments.styles.inkpot.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .env\Lib\site-packages\pygments\styles\inkpot.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.pygments.styles.inkpot.source.html#l21">
                  <tt><i>21</i>     </tt>
               </a>
            </li>
            </ul>
