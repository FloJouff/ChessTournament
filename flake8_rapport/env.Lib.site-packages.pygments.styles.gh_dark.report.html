...
<html>
   <head>
      <title>flake8 violations: .env\Lib\site-packages\pygments\styles\gh_dark.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.pygments.styles.gh_dark.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .env\Lib\site-packages\pygments\styles\gh_dark.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.pygments.styles.gh_dark.source.html#l46">
                  <tt><i>46</i>     </tt>
               </a>
            </li>
            </ul>
